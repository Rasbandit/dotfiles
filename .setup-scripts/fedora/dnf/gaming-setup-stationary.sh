...
echo "10.0.20.214:/mnt/cache/emulators/dolphin/desktop/GameSettings    /home/${USER}/.local/share/dolphin-emu/GameSettings    nfs4    rw,hard,intr,noatime,_netdev    0    0" | sudo tee -a /etc/fstab
